...
export const getSidebarCategories = () => [
  { display_name: t("pages.flow.sidebar.components.saved"), name: "saved_components", icon: "GradientSave" },
  { display_name: t("pages.flow.sidebar.components.inputs"), name: "inputs", icon: "Download" },
  { display_name: t("pages.flow.sidebar.components.outputs"), name: "outputs", icon: "Upload" },
  { display_name: t("pages.flow.sidebar.components.prompts"), name: "prompts", icon: "TerminalSquare" },
  { display_name: t("pages.flow.sidebar.components.data"), name: "data", icon: "Database" },
  { display_name: t("pages.flow.sidebar.components.processing"), name: "processing", icon: "ListFilter" },
  { display_name: t("pages.flow.sidebar.components.models"), name: "models", icon: "BrainCircuit" },
  { display_name: t("pages.flow.sidebar.components.vector_stores"), name: "vectorstores", icon: "Layers" },
  { display_name: t("pages.flow.sidebar.components.embeddings"), name: "embeddings", icon: "Binary" },
  { display_name: t("pages.flow.sidebar.components.agents"), name: "agents", icon: "Bot" },
  { display_name: t("pages.flow.sidebar.components.chains"), name: "chains", icon: "Link" },
  { display_name: t("pages.flow.sidebar.components.documentloaders"), name: "documentloaders", icon: "Paperclip" },
  { display_name: t("pages.flow.sidebar.components.link_extractors"), name: "link_extractors", icon: "Link2" },
  { display_name: t("pages.flow.sidebar.components.memories"), name: "memories", icon: "Cpu" },
  { display_name: t("pages.flow.sidebar.components.output_parsers"), name: "output_parsers", icon: "Compass" },
  { display_name: t("pages.flow.sidebar.components.prototypes"), name: "prototypes", icon: "FlaskConical" },
  { display_name: t("pages.flow.sidebar.components.retrievers"), name: "retrievers", icon: "FileSearch" },
  { display_name: t("pages.flow.sidebar.components.text_splitters"), name: "textsplitters", icon: "Scissors" },
  { display_name: t("pages.flow.sidebar.components.toolkits"), name: "toolkits", icon: "Package2" },
  { display_name: t("pages.flow.sidebar.components.tools"), name: "tools", icon: "Hammer" },
  { display_name: t("pages.flow.sidebar.components.logic"), name: "logic", icon: "ArrowRightLeft" },
  { display_name: t("pages.flow.sidebar.components.helpers"), name: "helpers", icon: "Wand2" },
];

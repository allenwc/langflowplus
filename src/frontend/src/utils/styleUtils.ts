...
export const SIDEBAR_CATEGORIES = [
  ...
  { display_name: t("components.prompts"), name: "prompts", icon: "TerminalSquare" },
  { display_name: t("components.data"), name: "data", icon: "Database" },
  { display_name: t("components.processing"), name: "processing", icon: "ListFilter" },
  { display_name: t("components.models"), name: "models", icon: "BrainCircuit" },
  { display_name: t("components.vector_stores"), name: "vectorstores", icon: "Layers" },
  { display_name: t("components.embeddings"), name: "embeddings", icon: "Binary" },
  { display_name: t("components.agents"), name: "agents", icon: "Bot" },
  { display_name: t("components.chains"), name: "chains", icon: "Link" },
  { display_name: t("components.documentloaders"), name: "documentloaders", icon: "Paperclip" },
  { display_name: t("components.link_extractors"), name: "link_extractors", icon: "Link2" },
  { display_name: t("components.memories"), name: "memories", icon: "Cpu" },
  { display_name: t("components.output_parsers"), name: "output_parsers", icon: "Compass" },
  { display_name: t("components.prototypes"), name: "prototypes", icon: "FlaskConical" },
  { display_name: t("components.retrievers"), name: "retrievers", icon: "FileSearch" },
  { display_name: t("components.text_splitters"), name: "textsplitters", icon: "Scissors" },
  { display_name: t("components.toolkits"), name: "toolkits", icon: "Package2" },
  { display_name: t("components.tools"), name: "tools", icon: "Hammer" },
  { display_name: t("components.logic"), name: "logic", icon: "ArrowRightLeft" },
  { display_name: t("components.helpers"), name: "helpers", icon: "Wand2" },
];
